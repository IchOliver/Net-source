...
export const Navigation: React.FC = () => {
    return(
        <div className="lg:flex items-center justify-between py-8 lg:px-8 xl:px-0 px-0 hidden">
            <div>
            ...
            <div>
                <ul className="flex items-center f-r-t">
                    <li className="pr-10 text-lg focus:text-teal text-custom-black cursor-pointer"><Link href="/"><a>Home</a></Link></li>
                    <li className="pr-10 text-lg focus:text-teal text-custom-black cursor-pointer"><Link href="/about"><a>About Us</a></Link></li>
                    <li className="pr-10 text-lg focus:text-teal text-custom-black cursor-pointer"><Link href="/plans"><a>Plans</a></Link></li>
                    <li>
                        <a href="tel:1300503984">
                            <button className="flex items-center bg-button-1 text-white py-4 px-5 border-radius-btn">
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-phone-call" width={36} height={36} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    <path d="M5 4h4l2 5l-2.5 1.5a11 11 0 0 0 5 5l1.5 -2.5l5 2v4a2 2 0 0 1 -2 2a16 16 0 0 1 -15 -15a2 2 0 0 1 2 -2" />
                                    <path d="M15 7a2 2 0 0 1 2 2" />
                                    <path d="M15 3a6 6 0 0 1 6 6" />
                                </svg>
                                <p className="Eina01-regular text-2xl">1300 503 984</p>
                            </button>
                        </a>
                    </li>
                </ul>
