...
import {AboutPageStyle} from './css'
import {Navigation} from '../LandingPage/Navigation'
import {ResponsiveNavigation} from '../LandingPage/ResponsiveNavigation'
...
const AboutLandingPage:React.FC<Props>= props=>{
         ...
         {/* Footer */}
           <div className="footer">
                    <div className="xl:block hidden f-r-t">
                        ...
                        <div className="mx-auto container">
                            <p className="Eina01-regular text-center text-base text-dark-blue mb-4">Copyright 2020 - Source Internet Pty Ltd ABN: 123 456 789 01 - All rights reserved.</p>
                    ...
                    <div className="xl:hidden block f-r-t">
                        <div className="p-6">
                            ...
                            <div className="mt-1">
                                <p className="Eina01-regular text-dark-blue text-ss">Copyright 2020 - Source Internet Pty Ltd ABN: 123 456 789 01 - All rights reserved.</p>
                            </div>
                            <div className="mt-1">
